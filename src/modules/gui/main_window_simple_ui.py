...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(607, 343)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.tabWidget = QtWidgets.QTabWidget(self.centralwidget)
        self.tabWidget.setGeometry(QtCore.QRect(0, 10, 311, 161))
        ...
        self.label_9.setGeometry(QtCore.QRect(420, 30, 71, 16))
        self.label_9.setObjectName("label_9")
        self.lcd_stored_2 = QtWidgets.QLCDNumber(self.centralwidget)
        self.lcd_stored_2.setGeometry(QtCore.QRect(420, 100, 64, 23))
        self.lcd_stored_2.setObjectName("lcd_stored_2")
        self.lcd_stored_1 = QtWidgets.QLCDNumber(self.centralwidget)
        self.lcd_stored_1.setGeometry(QtCore.QRect(420, 60, 64, 23))
        self.lcd_stored_1.setObjectName("lcd_stored_1")
        self.goto_1 = QtWidgets.QPushButton(self.centralwidget)
        self.goto_1.setGeometry(QtCore.QRect(500, 60, 51, 28))
        self.goto_1.setObjectName("goto_1")
        self.goto_2 = QtWidgets.QPushButton(self.centralwidget)
        self.goto_2.setGeometry(QtCore.QRect(500, 100, 51, 28))
        self.goto_2.setObjectName("goto_2")
        self.storeButton = QtWidgets.QPushButton(self.centralwidget)
        self.storeButton.setGeometry(QtCore.QRect(420, 140, 61, 28))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_9.setText(_translate("MainWindow", "stored pos."))
        self.goto_1.setText(_translate("MainWindow", "GoTo"))
